...
/** Management+ roles. These can open the restricted ticket types. */
export const HIGH_RANK_ROLE_IDS = [
...
export const TICKET_TYPES: TicketType[] = [
  ...
  },
  {
    ...
    color: 0xed4245,
    openRoles: HIGH_RANK_ROLE_IDS,
    viewRoles: HIGH_RANK_ROLE_IDS,
  },
  {
    slug: "complaint",
    name: "Complaint",
...
/** Returns true if the user can VIEW tickets of this type. viewRoles is enforced literally. */
