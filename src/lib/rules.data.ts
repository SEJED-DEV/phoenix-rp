...
export const categories: RuleCategory[] = [
  {
    ...
    rules: [
      ...
      { title: "Revenge Kill", desc: "Ken makech f gang lazemek record & info rp & 2h bech tnajam ta3mal revenge!" },
      ...
      { title: "No Fight Without Interaction", desc: "Any fight without interaction (social scene) = ban 4 days for the player who started + gang strike." },
  ...
  },
  {
    ...
    rules: [
      ...
      { title: "Gang War Requirements", desc: "Interdit gang war men4ir ma zouz bosses yet9ablou w yahkiw — lazem reason 9wey w record. Revenge after 24 hours. Sanction: gang strike." },
      { title: "Fight Limit", desc: "Ay gang tbda akther mn fight fi nhar ttsma power gaming — fiha gang strike." },
      { title: "No Unofficial Fight Looting", desc: "Interdit loot fi ay fight mouch official." },
      { title: "Official Fight / Gang War", desc: "Fight official wala gang war ma t9ich ella ba3d scene mafia." },
      { title: "React Cooldown", desc: "React ma tsir ken ba3ed 24h — gang amlet act matnajem lgang lokhra tamel react ken ba3ed 24h." },
      ...
      { title: "Gangster Info Leak", desc: "Interdit gangster yaati info l gang mte3ou wala l mafia lel police — tafsid rp + fail rp = ban 15 days." },
      { title: "Mort RP / Attack Gang", desc: "Mort rp wala besh te3dem wehed mel gang lezm ikoun 3andek reason w tsiir scene e3dem." },
  ...
  },
  {
    ...
    rules: [
      ...
      { title: "Gang War Protocol", desc: "Fi 7alet woujoud gang war, el hakem yo93od yestana men b3id lin tekmel el fight, w mba3d ysay9 ki youfa el fight." },
  ...
  },
  {
    ...
    rules: [
      ...
      { title: "No Corrupt EMS", desc: "Interdit tkoun EMS fesed — example: taati infos lel gangs 3al police wala tbi3 material. Ama tnajem ikalmouk tfaya9 chkoun f noir w to5les." },
    ],
  },
];
