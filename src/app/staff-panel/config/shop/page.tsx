...
export const metadata: Metadata = {
  title: "Shop Config — Staff Panel",
  description: "Manage the items shown on the public shop page.",
};
...
export default async function ShopConfigPage() {
  ...
  const allowed = await canEditSiteConfigScope(userId, userRoles, "content");
      ...
      <main className="pt-16 lg:pt-[64px] min-h-screen bg-bg">
        <div className="text-center py-40">
          ...
          <p className="text-text-muted text-sm mb-6">
            Only the site owner or granted content editors can access this page.
          </p>
